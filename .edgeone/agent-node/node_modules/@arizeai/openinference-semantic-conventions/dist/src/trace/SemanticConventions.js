...
exports.LLM_INVOCATION_PARAMETERS = exports.LLM_PROMPTS = exports.LLM_INPUT_MESSAGES = exports.OUTPUT_IMAGES = exports.OUTPUT_MIME_TYPE = exports.OUTPUT_VALUE = exports.INPUT_IMAGES = exports.INPUT_MIME_TYPE = exports.INPUT_VALUE = exports.EVALUATION_METADATA = exports.EVALUATION_IDENTIFIER = exports.EVALUATION_ANNOTATOR_KIND = exports.EVALUATION_EXPLANATION = exports.EVALUATION_LABEL = exports.EVALUATION_SCORE = exports.EVALUATION_NAME = exports.ANNOTATION_METADATA = exports.ANNOTATION_IDENTIFIER = exports.ANNOTATION_ANNOTATOR_KIND = exports.ANNOTATION_EXPLANATION = exports.ANNOTATION_LABEL = exports.ANNOTATION_SCORE = exports.ANNOTATION_NAME = exports.SESSION_EVALUATIONS = exports.SESSION_ANNOTATIONS = exports.TRACE_EVALUATIONS = exports.TRACE_ANNOTATIONS = exports.EVALUATIONS = exports.ANNOTATIONS = exports.FeedbackAttributePostfixes = exports.GraphPostfixes = exports.AgentPostfixes = exports.PromptAttributePostfixes = exports.AudioAttributesPostfixes = exports.UserAttributePostfixes = exports.SessionAttributePostfixes = exports.TagAttributePostfixes = exports.DocumentAttributePostfixes = exports.ToolCallAttributePostfixes = exports.VideoAttributesPostfixes = exports.ImageAttributesPostfixes = exports.MessageContentsAttributePostfixes = exports.MessageAttributePostfixes = exports.ToolAttributePostfixes = exports.EmbeddingAttributePostfixes = exports.RerankerAttributePostfixes = exports.RetrievalAttributePostfixes = exports.LLMPromptTemplateAttributePostfixes = exports.LLMAttributePostfixes = exports.SemanticAttributePrefixes = void 0;
exports.MESSAGE_CONTENT_DATA = exports.MESSAGE_CONTENT_SIGNATURE = exports.MESSAGE_CONTENT_ID = exports.MESSAGE_CONTENT_VIDEO = exports.MESSAGE_CONTENT_AUDIO = exports.MESSAGE_CONTENT_IMAGE = exports.MESSAGE_CONTENT_TEXT = exports.MESSAGE_CONTENT_TYPE = exports.MESSAGE_CONTENTS = exports.MESSAGE_CONTENT = exports.MESSAGE_FUNCTION_CALL_ARGUMENTS_JSON = exports.MESSAGE_FUNCTION_CALL_NAME = exports.TOOL_CALL_REASONING_SIGNATURE = exports.TOOL_CALL_ID = exports.TOOL_CALL_FUNCTION_ARGUMENTS_JSON = exports.TOOL_CALL_FUNCTION_NAME = exports.MESSAGE_TOOL_CALL_ID = exports.MESSAGE_TOOL_CALLS = exports.MESSAGE_NAME = exports.MESSAGE_ROLE = exports.LLM_COST_PROMPT_DETAILS_AUDIO = exports.LLM_COST_PROMPT_DETAILS_CACHE_INPUT = exports.LLM_COST_PROMPT_DETAILS_CACHE_READ = exports.LLM_COST_PROMPT_DETAILS_CACHE_WRITE = exports.LLM_COST_COMPLETION_DETAILS_AUDIO = exports.LLM_COST_COMPLETION_DETAILS_REASONING = exports.LLM_COST_OUTPUT = exports.LLM_COST_INPUT = exports.LLM_COST_TOTAL = exports.LLM_COST_COMPLETION = exports.LLM_COST_PROMPT = exports.LLM_COST = exports.LLM_TOKEN_COUNT_COMPLETION_DETAILS = exports.LLM_TOKEN_COUNT_PROMPT_DETAILS = exports.LLM_FINISH_REASON = exports.LLM_TOKEN_COUNT_TOTAL = exports.LLM_TOKEN_COUNT_PROMPT_DETAILS_AUDIO = exports.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_INPUT = exports.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_READ = exports.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_WRITE = exports.LLM_TOKEN_COUNT_PROMPT = exports.LLM_TOKEN_COUNT_COMPLETION_DETAILS_AUDIO = exports.LLM_TOKEN_COUNT_COMPLETION_DETAILS_REASONING = exports.LLM_TOKEN_COUNT_COMPLETION = exports.LLM_SYSTEM = exports.LLM_PROVIDER = exports.LLM_RESPONSE_MODEL_NAME = exports.LLM_REQUEST_MODEL_NAME = exports.LLM_MODEL_NAME = exports.LLM_OUTPUT_MESSAGES = void 0;
exports.LLMProvider = exports.LLMSystem = exports.MimeType = exports.OpenInferenceSpanKind = exports.AnnotatorKind = exports.SemanticConventions = exports.GRAPH_NODE_PARENT_ID = exports.GRAPH_NODE_NAME = exports.GRAPH_NODE_ID = exports.AGENT_NAME = exports.PROMPT_URL = exports.PROMPT_ID = exports.PROMPT_VENDOR = exports.AUDIO_TRANSCRIPT = exports.AUDIO_MIME_TYPE = exports.AUDIO_URL = exports.TAG_TAGS = exports.PROMPT_TEMPLATE_VERSION = exports.METADATA = exports.RERANKER_TOP_K = exports.RERANKER_MODEL_NAME = exports.RERANKER_QUERY = exports.RERANKER_OUTPUT_DOCUMENTS = exports.RERANKER_INPUT_DOCUMENTS = exports.USER_ID = exports.SESSION_ID = exports.TOOL_ID = exports.TOOL_JSON_SCHEMA = exports.TOOL_PARAMETERS = exports.TOOL_DESCRIPTION = exports.TOOL_NAME = exports.LLM_TOOLS = exports.LLM_FUNCTION_CALL = exports.PROMPT_TEMPLATE_TEMPLATE = exports.PROMPT_TEMPLATE_VARIABLES = exports.RETRIEVAL_DOCUMENTS = exports.EMBEDDING_EMBEDDINGS = exports.EMBEDDING_VECTOR = exports.EMBEDDING_MODEL_NAME = exports.EMBEDDING_TEXT = exports.DOCUMENT_METADATA = exports.DOCUMENT_SCORE = exports.DOCUMENT_CONTENT = exports.DOCUMENT_ID = exports.VIDEO_URL = exports.IMAGE_URL = exports.MESSAGE_CONTENT_ENCRYPTED_CONTENT = void 0;
...
exports.VideoAttributesPostfixes = {
    url: "url",
};
...
exports.FeedbackAttributePostfixes = {
    name: "name",
    score: "score",
    label: "label",
...
exports.ANNOTATIONS = exports.SemanticAttributePrefixes.annotations;
exports.EVALUATIONS = exports.SemanticAttributePrefixes.evaluations;
exports.TRACE_ANNOTATIONS = `${exports.SemanticAttributePrefixes.trace}.${exports.SemanticAttributePrefixes.annotations}`;
exports.TRACE_EVALUATIONS = `${exports.SemanticAttributePrefixes.trace}.${exports.SemanticAttributePrefixes.evaluations}`;
exports.SESSION_ANNOTATIONS = `${exports.SemanticAttributePrefixes.session}.${exports.SemanticAttributePrefixes.annotations}`;
exports.SESSION_EVALUATIONS = `${exports.SemanticAttributePrefixes.session}.${exports.SemanticAttributePrefixes.evaluations}`;
exports.ANNOTATION_NAME = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.name}`;
exports.ANNOTATION_SCORE = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.score}`;
exports.ANNOTATION_LABEL = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.label}`;
exports.ANNOTATION_EXPLANATION = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.explanation}`;
exports.ANNOTATION_ANNOTATOR_KIND = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.annotator_kind}`;
exports.ANNOTATION_IDENTIFIER = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.identifier}`;
exports.ANNOTATION_METADATA = `${exports.SemanticAttributePrefixes.annotation}.${exports.FeedbackAttributePostfixes.metadata}`;
exports.EVALUATION_NAME = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.name}`;
exports.EVALUATION_SCORE = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.score}`;
exports.EVALUATION_LABEL = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.label}`;
exports.EVALUATION_EXPLANATION = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.explanation}`;
exports.EVALUATION_ANNOTATOR_KIND = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.annotator_kind}`;
exports.EVALUATION_IDENTIFIER = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.identifier}`;
exports.EVALUATION_METADATA = `${exports.SemanticAttributePrefixes.evaluation}.${exports.FeedbackAttributePostfixes.metadata}`;
/**
 ...
 */
exports.INPUT_IMAGES = `${exports.SemanticAttributePrefixes.input}.images`;
/**
 ...
 */
exports.OUTPUT_IMAGES = `${exports.SemanticAttributePrefixes.output}.images`;
/**
 ...
 */
exports.LLM_REQUEST_MODEL_NAME = `${exports.SemanticAttributePrefixes.llm}.${exports.LLMAttributePostfixes.request}.${exports.LLMAttributePostfixes.model_name}`;
/**
 ...
 */
exports.LLM_RESPONSE_MODEL_NAME = `${exports.SemanticAttributePrefixes.llm}.${exports.LLMAttributePostfixes.response}.${exports.LLMAttributePostfixes.model_name}`;
/**
 ...
 */
exports.MESSAGE_CONTENT_AUDIO = `${exports.SemanticAttributePrefixes.message_content}.${exports.MessageContentsAttributePostfixes.audio}`;
/**
 * The video content of the message sent to the LLM
 */
exports.MESSAGE_CONTENT_VIDEO = `${exports.SemanticAttributePrefixes.message_content}.${exports.MessageContentsAttributePostfixes.video}`;
/**
 ...
 */
exports.VIDEO_URL = `${exports.SemanticAttributePrefixes.video}.${exports.VideoAttributesPostfixes.url}`;
...
exports.SemanticConventions = {
    ANNOTATIONS: exports.ANNOTATIONS,
    TRACE_ANNOTATIONS: exports.TRACE_ANNOTATIONS,
    SESSION_ANNOTATIONS: exports.SESSION_ANNOTATIONS,
    ANNOTATION_NAME: exports.ANNOTATION_NAME,
    ANNOTATION_SCORE: exports.ANNOTATION_SCORE,
    ANNOTATION_LABEL: exports.ANNOTATION_LABEL,
    ANNOTATION_EXPLANATION: exports.ANNOTATION_EXPLANATION,
    ANNOTATION_ANNOTATOR_KIND: exports.ANNOTATION_ANNOTATOR_KIND,
    ANNOTATION_IDENTIFIER: exports.ANNOTATION_IDENTIFIER,
    ANNOTATION_METADATA: exports.ANNOTATION_METADATA,
    EVALUATIONS: exports.EVALUATIONS,
    TRACE_EVALUATIONS: exports.TRACE_EVALUATIONS,
    SESSION_EVALUATIONS: exports.SESSION_EVALUATIONS,
    EVALUATION_NAME: exports.EVALUATION_NAME,
    EVALUATION_SCORE: exports.EVALUATION_SCORE,
    EVALUATION_LABEL: exports.EVALUATION_LABEL,
    EVALUATION_EXPLANATION: exports.EVALUATION_EXPLANATION,
    EVALUATION_ANNOTATOR_KIND: exports.EVALUATION_ANNOTATOR_KIND,
    EVALUATION_IDENTIFIER: exports.EVALUATION_IDENTIFIER,
    EVALUATION_METADATA: exports.EVALUATION_METADATA,
    IMAGE_URL: exports.IMAGE_URL,
    VIDEO_URL: exports.VIDEO_URL,
    INPUT_VALUE: exports.INPUT_VALUE,
    INPUT_MIME_TYPE: exports.INPUT_MIME_TYPE,
    INPUT_IMAGES: exports.INPUT_IMAGES,
    OUTPUT_VALUE: exports.OUTPUT_VALUE,
    OUTPUT_MIME_TYPE: exports.OUTPUT_MIME_TYPE,
    OUTPUT_IMAGES: exports.OUTPUT_IMAGES,
    ...
    LLM_REQUEST_MODEL_NAME: exports.LLM_REQUEST_MODEL_NAME,
    LLM_RESPONSE_MODEL_NAME: exports.LLM_RESPONSE_MODEL_NAME,
    ...
    MESSAGE_CONTENT_AUDIO: exports.MESSAGE_CONTENT_AUDIO,
    MESSAGE_CONTENT_VIDEO: exports.MESSAGE_CONTENT_VIDEO,
...
var AnnotatorKind;
(function (AnnotatorKind) {
    AnnotatorKind["HUMAN"] = "HUMAN";
    AnnotatorKind["LLM"] = "LLM";
    AnnotatorKind["CODE"] = "CODE";
})(AnnotatorKind || (exports.AnnotatorKind = AnnotatorKind = {}));

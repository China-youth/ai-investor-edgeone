...
export declare const VideoAttributesPostfixes: {
    readonly url: "url";
};
...
export declare const FeedbackAttributePostfixes: {
    readonly name: "name";
    readonly score: "score";
    readonly label: "label";
    readonly explanation: "explanation";
    readonly annotator_kind: "annotator_kind";
    readonly identifier: "identifier";
    readonly metadata: "metadata";
};
export declare const ANNOTATIONS: "annotations";
export declare const EVALUATIONS: "evaluations";
export declare const TRACE_ANNOTATIONS: "trace.annotations";
export declare const TRACE_EVALUATIONS: "trace.evaluations";
export declare const SESSION_ANNOTATIONS: "session.annotations";
export declare const SESSION_EVALUATIONS: "session.evaluations";
export declare const ANNOTATION_NAME: "annotation.name";
export declare const ANNOTATION_SCORE: "annotation.score";
export declare const ANNOTATION_LABEL: "annotation.label";
export declare const ANNOTATION_EXPLANATION: "annotation.explanation";
export declare const ANNOTATION_ANNOTATOR_KIND: "annotation.annotator_kind";
export declare const ANNOTATION_IDENTIFIER: "annotation.identifier";
export declare const ANNOTATION_METADATA: "annotation.metadata";
export declare const EVALUATION_NAME: "evaluation.name";
export declare const EVALUATION_SCORE: "evaluation.score";
export declare const EVALUATION_LABEL: "evaluation.label";
export declare const EVALUATION_EXPLANATION: "evaluation.explanation";
export declare const EVALUATION_ANNOTATOR_KIND: "evaluation.annotator_kind";
export declare const EVALUATION_IDENTIFIER: "evaluation.identifier";
export declare const EVALUATION_METADATA: "evaluation.metadata";
/**
 ...
 */
export declare const INPUT_IMAGES: "input.images";
/**
 ...
 */
export declare const OUTPUT_IMAGES: "output.images";
/**
 ...
 */
export declare const LLM_REQUEST_MODEL_NAME: "llm.request.model_name";
/**
 ...
 */
export declare const LLM_RESPONSE_MODEL_NAME: "llm.response.model_name";
/**
 ...
 */
export declare const MESSAGE_CONTENT_AUDIO: "message_content.audio";
/**
 * The video content of the message sent to the LLM
 */
export declare const MESSAGE_CONTENT_VIDEO: "message_content.video";
/**
 ...
 */
export declare const VIDEO_URL: "video.url";
...
export declare const SemanticConventions: {
    readonly ANNOTATIONS: "annotations";
    readonly TRACE_ANNOTATIONS: "trace.annotations";
    readonly SESSION_ANNOTATIONS: "session.annotations";
    readonly ANNOTATION_NAME: "annotation.name";
    readonly ANNOTATION_SCORE: "annotation.score";
    readonly ANNOTATION_LABEL: "annotation.label";
    readonly ANNOTATION_EXPLANATION: "annotation.explanation";
    readonly ANNOTATION_ANNOTATOR_KIND: "annotation.annotator_kind";
    readonly ANNOTATION_IDENTIFIER: "annotation.identifier";
    readonly ANNOTATION_METADATA: "annotation.metadata";
    readonly EVALUATIONS: "evaluations";
    readonly TRACE_EVALUATIONS: "trace.evaluations";
    readonly SESSION_EVALUATIONS: "session.evaluations";
    readonly EVALUATION_NAME: "evaluation.name";
    readonly EVALUATION_SCORE: "evaluation.score";
    readonly EVALUATION_LABEL: "evaluation.label";
    readonly EVALUATION_EXPLANATION: "evaluation.explanation";
    readonly EVALUATION_ANNOTATOR_KIND: "evaluation.annotator_kind";
    readonly EVALUATION_IDENTIFIER: "evaluation.identifier";
    readonly EVALUATION_METADATA: "evaluation.metadata";
    readonly IMAGE_URL: "image.url";
    readonly VIDEO_URL: "video.url";
    readonly INPUT_VALUE: "input.value";
    readonly INPUT_MIME_TYPE: "input.mime_type";
    readonly INPUT_IMAGES: "input.images";
    readonly OUTPUT_VALUE: "output.value";
    readonly OUTPUT_MIME_TYPE: "output.mime_type";
    readonly OUTPUT_IMAGES: "output.images";
    ...
    readonly LLM_REQUEST_MODEL_NAME: "llm.request.model_name";
    readonly LLM_RESPONSE_MODEL_NAME: "llm.response.model_name";
    ...
    readonly MESSAGE_CONTENT_AUDIO: "message_content.audio";
    readonly MESSAGE_CONTENT_VIDEO: "message_content.video";
...
export declare enum AnnotatorKind {
    HUMAN = "HUMAN",
    LLM = "LLM",
    CODE = "CODE"
}

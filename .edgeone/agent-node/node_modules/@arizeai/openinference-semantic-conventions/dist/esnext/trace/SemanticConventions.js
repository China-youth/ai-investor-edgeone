...
export const TRACE_ANNOTATIONS = `${SemanticAttributePrefixes.trace}.${SemanticAttributePrefixes.annotations}`;
export const TRACE_EVALUATIONS = `${SemanticAttributePrefixes.trace}.${SemanticAttributePrefixes.evaluations}`;
export const SESSION_ANNOTATIONS = `${SemanticAttributePrefixes.session}.${SemanticAttributePrefixes.annotations}`;
export const SESSION_EVALUATIONS = `${SemanticAttributePrefixes.session}.${SemanticAttributePrefixes.evaluations}`;
export const ANNOTATION_NAME = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.name}`;
export const ANNOTATION_SCORE = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.score}`;
export const ANNOTATION_LABEL = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.label}`;
export const ANNOTATION_EXPLANATION = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.explanation}`;
export const ANNOTATION_ANNOTATOR_KIND = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.annotator_kind}`;
export const ANNOTATION_IDENTIFIER = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.identifier}`;
export const ANNOTATION_METADATA = `${SemanticAttributePrefixes.annotation}.${FeedbackAttributePostfixes.metadata}`;
export const EVALUATION_NAME = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.name}`;
export const EVALUATION_SCORE = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.score}`;
export const EVALUATION_LABEL = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.label}`;
export const EVALUATION_EXPLANATION = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.explanation}`;
export const EVALUATION_ANNOTATOR_KIND = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.annotator_kind}`;
export const EVALUATION_IDENTIFIER = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.identifier}`;
export const EVALUATION_METADATA = `${SemanticAttributePrefixes.evaluation}.${FeedbackAttributePostfixes.metadata}`;
/**
 ...
 */
export const INPUT_IMAGES = `${SemanticAttributePrefixes.input}.images`;
/**
 ...
 */
export const OUTPUT_IMAGES = `${SemanticAttributePrefixes.output}.images`;
/**
 ...
 */
export const LLM_REQUEST_MODEL_NAME = `${SemanticAttributePrefixes.llm}.${LLMAttributePostfixes.request}.${LLMAttributePostfixes.model_name}`;
/**
 ...
 */
export const LLM_RESPONSE_MODEL_NAME = `${SemanticAttributePrefixes.llm}.${LLMAttributePostfixes.response}.${LLMAttributePostfixes.model_name}`;
/**
 ...
 */
export const MESSAGE_CONTENT_AUDIO = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.audio}`;
/**
 * The video content of the message sent to the LLM
 */
export const MESSAGE_CONTENT_VIDEO = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.video}`;
/**
 ...
 */
export const VIDEO_URL = `${SemanticAttributePrefixes.video}.${VideoAttributesPostfixes.url}`;

 ...
 * ```
 */
function setPromptTemplate(context, promptTemplate) {
...
function getPromptTemplate(context) {
    ...
    if (typeof maybeVariables === "string") {
        ...
        attributes.variables = (0, utils_1.isObjectWithStringKeys)(parsedVariables) ? parsedVariables : undefined;
    }
 ...
 * ```
 */
function setMetadata(context, metadata) {
    return context.setValue(METADATA_KEY, (0, utils_1.safelyJSONStringify)(metadata));
}
/**
 ...
 * ```
 */
function setTags(context, tags) {
    return context.setValue(TAG_TAGS_KEY, (0, utils_1.safelyJSONStringify)(tags));
}
/**

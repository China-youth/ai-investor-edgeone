...
import type { Annotation, AnnotationScope, Document, Embedding, InputToAttributesFn, Message, OutputToAttributesFn, SpanInput, SpanOutput, TokenCount, Tool } from "./types.js";
/**
 ...
 * ```
 */
export declare function getAnnotationAttributes(options: {
 ...
 * ```
 */
export declare function getEvaluationAttributes(options: {

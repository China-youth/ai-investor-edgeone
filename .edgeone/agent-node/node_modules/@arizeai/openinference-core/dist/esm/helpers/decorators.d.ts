 ...
 * ```
 */
export declare function observe<Fn extends AnyFn>(options?: SpanTraceOptions): (originalMethod: Fn, ctx: ClassMethodDecoratorContext) => ((this: unknown, ...args: Parameters<Fn>) => any) & Fn;
